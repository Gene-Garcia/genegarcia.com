      ...
      <div className="lg:w-1/2 xl:w-2/5 flex justify-center items-center">
        <div className="relative">
          ...
          <a
            ...
            target="_blank"
            className="absolute right-4 sm:right-6 lg:right-9 bottom-7 h-12 w-12 rounded-full bg-accent shadow-xl text-white transition duration-200 ease-linear ring-4 ring-transparent hover:ring-accent hover:ring-opacity-40"
          >
            <svg
